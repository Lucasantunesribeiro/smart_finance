...
ALTER TABLE accounts
  ...
  ADD CONSTRAINT accounts_external_id_unique UNIQUE (user_id, external_id);
...
ALTER TABLE categories
  ADD COLUMN IF NOT EXISTS external_id UUID DEFAULT gen_random_uuid(),
  ADD CONSTRAINT categories_external_id_unique UNIQUE (user_id, external_id);
...
ALTER TABLE budgets
  ADD COLUMN IF NOT EXISTS external_id UUID DEFAULT gen_random_uuid(),
  ADD CONSTRAINT budgets_external_id_unique UNIQUE (user_id, external_id);
...
ALTER TABLE transactions
  ...
  ADD CONSTRAINT transactions_external_id_unique UNIQUE (user_id, external_id);
